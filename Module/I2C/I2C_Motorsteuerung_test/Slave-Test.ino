...
#define i2c_bufferReadLength 18
#define i2c_bufferWriteLength 18
...
volatile uint16_t *i2c_16BitArray; //Hieraus lesen
volatile int8_t i2c_counter = 0;

volatile uint8_t newData=0;
volatile uint8_t motortimer=0; //Eventvariable für Motortimer
...
void loop() {
  if(newData!=0&&i2c_16BitArray[2]!=0){
  newData=0;
  i2c_16BitArray[2]=0;
  switch(i2c_16BitArray[0]){
    case MmotorA_direction:
      motorA_direction(i2c_16BitArray[1]);
      break;
    case MmotorA_speed:
      motorA_speed(i2c_16BitArray[1]);
      break;
    case MmotorA_acceleration:
      motorA_acceleration(i2c_16BitArray[1]);
      break;
    case MmotorA_microStep:
      motorA_microStep(i2c_16BitArray[1]);
      break;
    case MmotorA_enable:
      motorA_enable();
      break;
    case MmotorA_disable:
      motorA_disable();
      break;
    case MmotorB_direction:
      motorB_direction(i2c_16BitArray[1]);
      break;
    case MmotorB_speed:
      motorB_speed(i2c_16BitArray[1]);
      break;
    case MmotorB_acceleration:
      motorB_acceleration(i2c_16BitArray[1]);
      break;
    case MmotorB_microStep:
      motorB_microStep(i2c_16BitArray[1]);
      break;
    case MmotorB_enable:
      motorB_enable();
      break;
    case MmotorB_disable:
      motorB_disable();
      break;
     }
  }
    /*if(i2c_16BitArray[0]==0){
