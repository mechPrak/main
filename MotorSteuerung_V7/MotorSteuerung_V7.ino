...
enum {ACCEL, DECEL, CONST, CW, CCW, L, R, FWD, STOP};

uint8_t instructions[15];
...
void loop() {
  ...
  for (uint8_t i = 0; i < 15; i++) {
    mc_motorA_stepCount = 0;
    mc_motorB_stepCount = 0;
    switch (instructions[i]) {
      case L:
        ...
        motorA_speed(25000);
        motorB_speed(25000);
        while(mc_motorA_stepCount < 1500);
        motorA_speed(0);
        motorB_speed(0);
        delay(500);
        break;
      ...
      case FWD:
        ...
        motorA_speed(25000);
        motorB_speed(25000);
        while(mc_motorA_stepCount < 5000);
        motorA_speed(0);
        motorB_speed(0);
        delay(500);
        break;
