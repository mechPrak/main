/*
 * Motorcontroller zur Ansteuerung von 2 Schrittmotoren
 *  - Lineares Beschleunigen und Bremsen
 *  - Anfahren von Abständen
 *  - Möglichkeit zum halten einer langsameren Drehzahl zum Auslesen von Sensorwerten und sofortigen Anhalten
 *  - effiziente Minimalanpassung der Geschwindigkeit für Linienfolgen
 * 
 * Zur Benutzung: 
 *    Im Setup:
 *    
 *    m_init();         //Werte und Interrupt initialisieren
      mr_enable();      //Motoren anschalten
      ml_enable();
 *    
 *    In der Loop:    
 *    
