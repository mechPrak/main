...
void setup() {
  ...
  motorA_acceleration(2000000);
  motorB_acceleration(2000000);
...
void motorA_speed(uint16_t target) {
 ...
 /*
  ...
  Serial.print("motorA_vBase: ");
  Serial.println(motorA_vBase);

  Serial.print("motorA_speedChange: ");
  Serial.println(motorA_speedChange);

  Serial.print("motorA_acc: ");
  Serial.println(motorA_acc);

  Serial.print("motorA_r: ");
  Serial.println(motorA_r);

  Serial.print("motorA_del_init: ");
  Serial.println(motorA_del_init);

  Serial.print("motorA_steps: ");
  Serial.println(motorA_steps);
  Serial.println();

  /*
     target: 10000
    motorA_vBase: 0.00
    motorA_speedChange: 0
    motorA_acc: 34464.00
    motorA_r: 0.00
    motorA_del_init: 609.43
    motorA_steps: 1450.79

    target: 0
    motorA_vBase: 10000.00
    motorA_speedChange: 1
    motorA_acc: 34464.00
    motorA_r: 0.00
    motorA_del_init: 15.99
    motorA_steps: 1450.79
*/
  sei();
}
